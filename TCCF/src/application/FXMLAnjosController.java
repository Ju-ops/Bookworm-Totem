...
public class FXMLAnjosController implements Initializable{
	@FXML
    private ImageView imgFundo, imgLogo, imgCD;

    @FXML
    private Label lblTitulo, lblSair, lblLocal, lblTituloL, lblCompositor, lblGenero, lblAno, lblDisponiveis;
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		try {
			produtoAtual = produto.getProduto(5);
		} catch (Exception e) {
